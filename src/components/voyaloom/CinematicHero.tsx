...
export function CinematicHero() {
  ...
  return (
    <section className="relative min-h-[680px] h-screen overflow-hidden flex items-center justify-center grain">
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 z-[2] cinematic-gradient" />
      </div>
      ...
      <div className="relative z-10 text-center px-5 sm:px-6 max-w-5xl pt-6">
        <motion.span
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 1, ease: [0.16, 1, 0.3, 1] }}
          className="block text-gold text-[10px] sm:text-xs uppercase tracking-[0.3em] sm:tracking-ultra mb-6 sm:mb-8"
        >
        ...
        <motion.h1
          ...
          className="font-serif text-4xl sm:text-5xl md:text-7xl lg:text-8xl leading-[0.98] text-sand mb-6 sm:mb-8"
        >
        ...
        <motion.p
          ...
          className="text-sm sm:text-base md:text-lg text-sand/60 font-light max-w-xl mx-auto mb-8 sm:mb-12 leading-relaxed"
        >
        ...
        >
          <Link
            to={ctaPath}
            className="group inline-flex items-center justify-center gap-3 bg-gold text-midnight px-6 sm:px-10 py-4 text-[10px] sm:text-xs uppercase tracking-[0.2em] sm:tracking-luxury font-semibold hover:bg-sand transition-all shadow-gold"
          >
          ...
          <Link
            to="/how-it-works"
            className="px-6 sm:px-10 py-4 border border-white/20 text-sand text-[10px] sm:text-xs uppercase tracking-[0.2em] sm:tracking-luxury font-semibold hover:bg-white/5 transition-all"
          >
            See how it works
          </Link>
        </motion.div>
